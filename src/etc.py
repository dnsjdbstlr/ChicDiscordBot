...
def getChicBotDesc(page):
    if page == 1:
        ...
        title = "오류"
    desc  = "◀️ ▶️ 이모지를 사용해서 원하는 페이지로 이동할 수 있어요."
    ...
    if page == 1:
        ...
        embed.add_field(name='> !주식',                  value='자신이 보유하고 있는 골드와 주식을 알려드려요.')
    ...
    embed.set_footer(text=f'3쪽 중 {page}쪽')
    return embed
